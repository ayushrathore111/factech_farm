...
def potatopredict():
    if request.method == 'POST':
        ...
        return render_template('potato.html',prediction = 'The Predicted Production is {}tonnes and Yield is {}tonnes/hectare'.format(prediction[0],yield_value))
